...
## SystemProjections.jl - Architecture and Implementation

This document describes the internal architecture, design decisions, and implementation details of SystemProjections.jl.


Based on [https://github.com/gragusa/MacroEconometricTools.jl](https://github.com/gragusa/MacroEconometricTools.jl)
---
