...
function aVar(k::CR, m::RegressionModel; scale = true, kwargs...)
...
"""
function aVar(k::CachedCRModel, m::RegressionModel; scale = true, kwargs...)
    cache = k.cache
...
"""
function StatsAPI.vcov(k::CachedCRModel, m::RegressionModel; dofadjust = true, kwargs...)
